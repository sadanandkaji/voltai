...
function HistoryPageContent() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <div className="vq-profile-container" style={{ maxWidth: 760, margin: "0 auto", padding: "32px 20px 60px" }}>
        <div style={{ marginBottom: 22 }}>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: "var(--text)", margin: 0 }}>Trip history</h1>
          <p style={{ fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--text3)", marginTop: 6 }}>
            {routes ? `${routes.length} trip${routes.length === 1 ? "" : "s"} planned` : "Loading your saved trips…"}
          </p>
        </div>

        {error && (
          <div style={{ background: "rgba(220,38,38,.08)", border: "1px solid rgba(220,38,38,.2)", borderRadius: 12, padding: 14, fontSize: 13, color: "#dc2626", marginBottom: 16 }}>
            ⚠️ {error}
          </div>
        )}
        ...
        {loading && (
          <div style={{ display: "flex", justifyContent: "center", padding: 60 }}>
            <div style={{ width: 26, height: 26, border: "3px solid rgba(34,197,94,.15)", borderTopColor: "var(--green)", borderRadius: "50%", animation: "spin .8s linear infinite" }} />
          </div>
        )}
        ...
        {routes && routes.length === 0 && (
          ...
          >
            ...
            <div style={{ fontSize: 15, fontWeight: 700, color: "var(--text)", marginBottom: 6 }}>No trips yet</div>
            <div style={{ fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--text3)", marginBottom: 18 }}>
            ...
            {routes.map((r) => {
              ...
              return (
                <button
                  ...
                  onMouseEnter={(e) => { if (!openingId) { e.currentTarget.style.borderColor = "var(--green-border)"; e.currentTarget.style.background = "var(--green-dim)"; } }}
                ...
                >
                  <div
                    style={{
                      ...
                      display: "flex", alignItems: "center", justifyContent: "center",
                      fontSize: 17,
                      background: r.willReachDestination ? "var(--green-dim)" : "rgba(220,38,38,.08)",
                      border: `1px solid ${r.willReachDestination ? "var(--green-border)" : "rgba(220,38,38,.2)"}`,
                    }}
                  >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", gap: 8, marginTop: 4, flexWrap: "wrap" }}>
                      ...
                      <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--text3)" }}>
                        · {r._count.chargingStations} charger{r._count.chargingStations !== 1 ? "s" : ""}
                      </span>
                      <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--text3)" }}>
                  ...
                  <span
                    style={{
                      fontSize: 9, padding: "3px 8px", borderRadius: 20, flexShrink: 0,
